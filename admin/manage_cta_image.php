...
// Handle image upload
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['cta_image'])) {
    try {
        // Simple validation
...
// Get current image
$currentImage = $conn->query("SELECT image_path FROM cta_images ORDER BY uploaded_at DESC LIMIT 1")->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Manage CTA Image</title>
...
<body>
    ...
    <div class="container mt-4">
        <h2>Update Call-to-Action Image</h2>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label class="form-label">Select New Image (Recommended: 800x600px)</label>
                ...
                <div class="mt-4">
                    ...
                    <img src="../<?= htmlspecialchars($currentImage['image_path']) ?>" 
                         class="img-fluid mt-2" style="max-height: 300px; border: 1px solid #ddd;">
                </div>
                <?php endif; ?>
            </div>
        </div>

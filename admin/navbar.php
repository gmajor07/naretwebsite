                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="manage_content.php">Home Page</a></li>
                            <li><a class="dropdown-item" href="manage_carousel.php">Carousel</a></li>
                            <li><a class="dropdown-item" href="manage_services.php">Services</a></li>
                            <li><a class="dropdown-item" href="manage_works.php">Recent Works</a></li>
                            <li><a class="dropdown-item" href="manage_about.php">Manage About</a></li>
                            <li><a class="dropdown-item" href="manage_about_image.php">Manage About Image</a></li>
                            <li><a class="dropdown-item" href="manage_cta_image.php">Manage CTA About</a></li>
                            <li><a class="dropdown-item" href="manage_cta_content.php">Manage CTA Contents</a></li>
                            ...
                            <li><a class="dropdown-item" href="manage_about_points.php">Manage About Points</a></li>
